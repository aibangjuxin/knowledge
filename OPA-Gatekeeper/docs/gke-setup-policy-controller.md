...
Operation "operations/acat.p2-487126826743-b47dd8bb-b1d8-447e-b4d1-b30aa3fbc51a" finished successfully.
```
...
在 GKE 中启用 Policy Controller（即您提到的 anthospolicycontroller），必须将集群注册到舰队（Fleet）。
...
- https://www.skills.google/focuses/89750?parent=catalog