# 在现有 PSC NEG 架构上引入 Cloud Service Mesh（Master Project）

> 文档版本: 1.0  
> 最后更新: 2026-03-14  
> 适用读者: 平台工程 / SRE / 基础设施团队  

---

## 1. Goal and Constraints（目标与约束）

### 1.1 你当前已经做到了什么（来自 3.md）

你已经用 **PSC NEG** 打通了跨项目链路（Tenant/Consumer → Master/Producer），并验证了 Shared VPC 权限粒度、Producer PSC NAT subnet 等关键点。
