- [跨 Namespace 网络策略配置分析](#跨-namespace-网络策略配置分析)
- [TCP 健康检查的局限性分析](#tcp-健康检查的局限性分析)
  - [问题分析](#问题分析)
  - [需要配置的 NetworkPolicy](#需要配置的-networkpolicy)
    - [1. Runtime-namespace：允许入站流量](#1-runtime-namespace允许入站流量)
    - [2. DP-namespace：允许出站流量（如有 Egress 限制）](#2-dp-namespace允许出站流量如有-egress-限制)
  - [流量路径说明](#流量路径说明)
  - [重要说明](#重要说明)
  - [验证步骤](#验证步骤)
  - [注意事项](#注意事项)
- [为什么 NetworkPolicy 不需要配置 8443 端口](#为什么-networkpolicy-不需要配置-8443-端口)
  - [核心原因](#核心原因)
  - [流量实际路径](#流量实际路径)
  - [验证示例](#验证示例)
  - [简单类比](#简单类比)
  - [结论](#结论)
- [API 平台健康检查与网络策略设计分析](#api-平台健康检查与网络策略设计分析)
  - [问题分析](#问题分析-1)
  - [重要澄清：健康检查的网络策略](#重要澄清健康检查的网络策略)
  - [端口标准化建议](#端口标准化建议)
    - [推荐方案：强制标准化端口](#推荐方案强制标准化端口)
    - [平台级 NetworkPolicy（一次性配置）](#平台级-networkpolicy一次性配置)
  - [如果必须支持多端口](#如果必须支持多端口)
  - [建议的平台规范](#建议的平台规范)
  - [总结](#总结)
- [TCP 健康检查的局限性分析](#tcp-健康检查的局限性分析-1)
  - [直接回答](#直接回答)
  - [TCP vs HTTP 健康检查对比](#tcp-vs-http-健康检查对比)
  - [实际场景举例](#实际场景举例)
  - [你面临的困境](#你面临的困境)
  - [推荐方案：分层健康检查策略](#推荐方案分层健康检查策略)
    - [方案设计](#方案设计)
    - [平台规范建议](#平台规范建议)
  - [落地建议](#落地建议)
  - [结论](#结论-1)
