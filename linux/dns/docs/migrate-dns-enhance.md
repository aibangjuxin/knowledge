# GCP DNS 迁移脚本 - 增强版
# 脚本目前有小问题就是在判断目标记录已经存在，创建天记录失败。是因为我的需求是CNAME记录
## 完整脚本
...
ENV="prod"
REGION="us-central1"
BASE_DOMAIN="aliyun.cloud.${REGION}.aibang"
...
==========================================
处理 [1]: pop-test
  源记录: pop-test.a-project.prod.aliyun.cloud.us-central1.aibang.
  目标记录: pop-test.b-project.prod.aliyun.cloud.us-central1.aibang.
  ✓ 目标记录存在
  当前指向: old-target.example.com.
  将更新为: pop-test.b-project.prod.aliyun.cloud.us-central1.aibang.
[DRY-RUN] 将执行更新操作
...
处理 [2]: already-migrated-api
  源记录: already-migrated-api.a-project.prod.aliyun.cloud.us-central1.aibang.
  目标记录: already-migrated-api.b-project.prod.aliyun.cloud.us-central1.aibang.
  ✓ 目标记录存在
⊘ already-migrated-api: 记录已经指向目标，无需更新
  当前指向: already-migrated-api.b-project.prod.aliyun.cloud.us-central1.aibang.
```
...
处理 [3]: missing-target-api
  源记录: missing-target-api.a-project.prod.aliyun.cloud.us-central1.aibang.
  目标记录: missing-target-api.b-project.prod.aliyun.cloud.us-central1.aibang.
...
gcloud dns record-sets create "missing-target-api.b-project.prod.aliyun.cloud.us-central1.aibang." \
    --type=CNAME \
    --ttl=300 \
