...
| `k8s/custom-liveness/explore-startprobe/verify_pod_measure_startup_fixed_en.sh` | Verifies pod startup measurements. and add if pod success get the Target URL                                                                                                                                        |
